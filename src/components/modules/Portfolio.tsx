...
export default function Portfolio() {
  return (
    <div className="space-y-4 sm:space-y-6">
      {/* Header */}
      <div className="rounded-3xl border border-slate-200 bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 p-5 shadow-sm sm:p-6 dark:border-slate-800 dark:from-indigo-950/40 dark:via-purple-950/30 dark:to-pink-950/30">
        ...
        <div className="mt-4 flex flex-wrap gap-2 text-xs">
          <span className="rounded-full bg-white px-3 py-1 font-medium text-indigo-700 shadow-sm dark:bg-slate-900 dark:text-indigo-300">Vibe Coding</span>
          <span className="rounded-full bg-white px-3 py-1 font-medium text-indigo-700 shadow-sm dark:bg-slate-900 dark:text-indigo-300">用户研究</span>
          <span className="rounded-full bg-white px-3 py-1 font-medium text-indigo-700 shadow-sm dark:bg-slate-900 dark:text-indigo-300">需求设计</span>
          <span className="rounded-full bg-white px-3 py-1 font-medium text-indigo-700 shadow-sm dark:bg-slate-900 dark:text-indigo-300">从 0 到 1 落地</span>
          <span className="rounded-full bg-white px-3 py-1 font-medium text-indigo-700 shadow-sm dark:bg-slate-900 dark:text-indigo-300">移动端适配</span>
          <span className="rounded-full bg-white px-3 py-1 font-medium text-indigo-700 shadow-sm dark:bg-slate-900 dark:text-indigo-300">双通道部署</span>
        </div>
      </div>
      ...
      <Section icon={<Code2 size={18} />} title="5. 实现路径：Vibe Coding 实践">
        ...
        <p className="rounded-xl bg-indigo-50 px-3 py-2 text-xs text-indigo-800 dark:bg-indigo-950/40 dark:text-indigo-200">
      ...
      {/* Footer CTA */}
      <div className="rounded-3xl border border-slate-200 bg-gradient-to-br from-slate-50 to-indigo-50 p-5 text-center shadow-sm sm:p-6 dark:border-slate-800 dark:from-slate-900 dark:to-indigo-950/40">
        ...
        <a
          ...
          className="mt-3 inline-flex items-center gap-2 rounded-full bg-ink px-5 py-2 text-sm font-medium text-paper transition hover:bg-slate-800 dark:bg-accent dark:text-slate-950 dark:hover:bg-indigo-300"
        >
