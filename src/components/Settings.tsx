...
export default function Settings({ open, onClose }: SettingsProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-[rgba(3,7,18,0.55)] px-4 backdrop-blur-[40px]">
      <div className="glass-card w-full max-w-md p-6">
        <div className="mb-4 flex items-start justify-between gap-3">
          <div>
            <div className="text-lg font-semibold t-strong">部署设置</div>
            <div className="mt-1 text-sm leading-6 t-weak">
        ...
        <div className="glass rounded-2xl p-4 text-sm leading-7 t-body">
